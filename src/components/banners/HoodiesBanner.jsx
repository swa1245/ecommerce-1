  ...
  return (
    <div className="relative h-[400px] w-full overflow-hidden">
      <div 
        ...
        style={{
          backgroundImage: `url('https://images.unsplash.com/photo-1556821840-3a63f95609a7?w=1600&auto=format')`,
        }}
      >
      ...
      <div className="relative h-full flex flex-col items-center justify-center text-white px-4">
        ...
        >
          ...
          <p className="text-xl mb-8 font-sans max-w-2xl mx-auto">
            Stay warm and trendy with our premium hoodie collection
          </p>
