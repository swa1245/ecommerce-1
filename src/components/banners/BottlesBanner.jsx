  ...
  return (
    <div className="relative h-[400px] w-full overflow-hidden">
      <div 
        ...
        style={{
          backgroundImage: `url('https://orchiddigitals.com/wp-content/uploads/2019/05/bottle-printing-on-sippers-makes-for-an-ideal-gift.jpg')`,
        }}
      >
      ...
      <div className="relative h-full flex flex-col items-center justify-center text-white px-4">
        ...
        >
          ...
          <p className="text-xl mb-8 font-sans max-w-2xl mx-auto">
            Stay hydrated in style with our eco-friendly water bottles
          </p>
          ...
          <div className="flex flex-wrap justify-center gap-8 mt-8">
            ...
            >
              ...
              <span className="font-medium">Leak Proof</span>
            </motion.div>
